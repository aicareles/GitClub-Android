...
import com.i502tech.gitclub.api.http.api.cookies.PersistentCookieStore;
import com.i502tech.gitclub.utils.AppUtils;
...
public class OkHttpManager {
    ...
    //设置缓存目录
    private static File cacheDirectory = new File(App.getContext().getCacheDir().getAbsolutePath(), "GitClub-Cache");
...
//                        .sslSocketFactory(setCertificates(App.getInstance().getAssets().open("https.cer")))
    ...
    private static class LogInterceptor implements Interceptor {
        ...
        public okhttp3.Response intercept(Chain chain) throws IOException {
            ...
            LogUtils.loge("LogInterceptor", String.format("发送请求 %s on %s%n%s%s",
